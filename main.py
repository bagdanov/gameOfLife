...
class Grid(Canvas, TkPeriodicCallMixin):
    ...
    COLOR_MAP = {
        0: '#FFDDDD',
        8: '#FF0000',  # "il rosso sta per folla"
        7: '#EE3333',
        6: '#DD4444',
        5: '#BB5555',
        4: '#996666',
        3: '#CCCC00',
        2: '#FFEE00',  # il giallo sta per stabile
        1: '#339999'
    }
    ...
    def __init__(self, *args, **kargs):
        ...
        self._size = (60, 40)
        self.conway_map = Conway_Map(60, 40)  # crea un  grid
        self.draw()
        self.start_polling()
...
class GridWindow(object):
    ...
    def __init__(self):
        ...
        self.root.title("game of life,Francesco Rostagno")

        descrition = u"left click on the grid to make new lives\n\
...
class Conway_Map(object):
    ...
    def count_map(self):
        '''
        conteggia la mappa memorizza il risultato in self.around_count
        attorno ad ogni blocco , conta tutti i blocchi vivi attorno ad essi
        '''
        for i in _xrange(60):
            for j in _xrange(40):
                arounds = [
